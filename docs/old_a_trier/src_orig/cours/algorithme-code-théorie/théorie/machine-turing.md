...
> [Algorithme, code et théorie]({% link cours/algorithme-code-théorie/index.md %}) / [théorie]({% link cours/algorithme-code-théorie/théorie/index.md %}) / [machine de Turing]({% link cours/algorithme-code-théorie/théorie/machine-turing.md %})
>
> prérequis :
>
...
La [machine de Turing](https://fr.wikipedia.org/wiki/Machine_de_Turing) est une façon simple d'implémenter les [4 règles générales d'un algorithme]({% link cours/algorithme-code-théorie/théorie/algorithmes-fonctions-pseudo-code.md %}#regles-generales). Turing lui-même a montré que :

> La machine de Turing permet exactement de calculer tout ce qu'on peut faire avec un [pseudo-code]({% link cours/algorithme-code-théorie/algorithme/pseudo-code.md %}#regles).
{.note}
