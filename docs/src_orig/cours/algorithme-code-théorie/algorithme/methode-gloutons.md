...
> [Algorithme, code et théorie]({% link cours/algorithme-code-théorie/index.md %}) / [algorithmie]({% link cours/algorithme-code-théorie/algorithme/index.md %}) / [algorithmes gloutons]({% link cours/algorithme-code-théorie/algorithme/methode-gloutons.md %})
>
> **prérequis :**
>
