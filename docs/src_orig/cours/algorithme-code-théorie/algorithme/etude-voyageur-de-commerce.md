...
> [Algorithme, code et théorie]({% link cours/algorithme-code-théorie/index.md %}) / [algorithmie]({% link cours/algorithme-code-théorie/algorithme/index.md %}) / [étude : voyageur de commerce]({% link cours/algorithme-code-théorie/algorithme/etude-voyageur-de-commerce.md %})
>
> **prérequis :**
>
...
On peut alors utiliser l'algorithme `permutation(T)` de l'[étude sur les mélanges]({% link cours/algorithme-code-théorie/algorithme/étude-mélange.md %}#algo-toutes-permutations) :
