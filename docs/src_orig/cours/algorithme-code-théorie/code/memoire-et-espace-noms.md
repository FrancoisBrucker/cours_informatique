...
> [Algorithme, code et théorie]({% link cours/algorithme-code-théorie/index.md %}) / [code]({% link cours/algorithme-code-théorie/code/index.md %}) / [mémoire et espace de noms]({% link cours/algorithme-code-théorie/code/memoire-et-espace-noms.md %})
>
> **prérequis :**
>
> * [coder]({% link cours/algorithme-code-théorie/code/coder.md %})
{.chemin}
