...
> [Algorithme, code et théorie]({% link cours/algorithme-code-theorie/index.md %}) / [code]({% link cours/algorithme-code-theorie/code/index.md %}) / [mise en oeuvre d'un projet]({% link cours/algorithme-code-theorie/code/projet-hello-dev.md %})
>
> **prérequis :**
>
...
![vsc-linter-souligne](./assets/code-vsc-linter.png){:style="margin: auto;display: block"}

On peut cliquer sur la status-bar pour voir l'erreur :

![vsc-linter-erreur](./assets/code-vsc-linter-2.png){:style="margin: auto;display: block"}

OU encore utiliser le terminal :

![vsc-linter-terminal](./assets/code-vsc-linter-3.png){:style="margin: auto;display: block"}
...
![vsc-pytest](./assets/code-projet-pytest.png){:style="margin: auto;display: block"}
...
![vsc-pytest-erlermeyer](./assets/code-projet-pytest-erlenmeyer.png){:style="margin: auto;display: block"}
...
les trois fichiers du projet final sont [disponibles](https://github.com/FrancoisBrucker/cours_informatique/tree/master/docs/cours/algorithme-code-theorie/code/projets-code/hello-dev)
