...
Vérifiez que vous avez bien installé les outils ssh et que vous avez un agent ssh en marche. Au pire, vous suivez [l'intallation ssl]({% link cours/ssh_et_shell/index.md %}#installation)
...
![image?]({{ "/assets/cours/ssh_et_shell/seasonning.png" | relative_url }}){:style="margin: auto;display: block;}
