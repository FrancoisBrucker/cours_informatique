...
[Selenium](https://www.selenium.dev) est un outil qui permet d’automatiser un browser. On peut l’utiliser pour simuler un utilisateur, et donc vérifier que le site fonctionne comme il devrait d’un point de vue utilisateur. 
