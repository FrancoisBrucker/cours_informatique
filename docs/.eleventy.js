      ...
      Prism.languages.pseudocode =
        {
          ...
          'keyword': /\b(?:_(?=\s*:)|et|ou|si|sinon si|sinon|répéter|pour chaque|pour|rendre|tant que|self)\b/,
          'builtin': /\b(?:entier|chiffre|booléen|bit|réel|caractère|chaîne|algorithme|fonction|structure|attributs|méthodes|méthode|création)\b/,
