...
En algorithmie par exemple, il ne faut pas hésiter à apprendre par cœur les algorithmes classiques du cours, ce qui vous permettra de les adapter ensuite à des problèmes proches pour enfin pouvoir s'en détacher et d'en inventer des innovants pour résoudre des problèmes nouveaux.
