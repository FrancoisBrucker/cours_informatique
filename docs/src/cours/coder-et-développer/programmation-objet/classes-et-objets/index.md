...
Pour représenter les différentes possibilités offertes par une classe on utilise l'[UML](<https://fr.wikipedia.org/wiki/UML_(informatique)>)
...
> code puis uml Exemple du compteur

### Modélisation python

> constructeur = nom de la classe
