...
> TBD exemple de création et d'utilisation : <https://blog.stephane-robert.info/docs/developper/programmation/python/tuple/> et <https://courspython.com/tuple.html>
> TBD dire que si on a le choix, c'est mieux d'utiliser des tuples car pas d'effet de bords.
>  
> TBD le tuple : Le tuple est un cas particulier de liste qui, une fois crée ne peut plus être modifié.
Attention les objets à l'intérieur le peuvent, eux...
