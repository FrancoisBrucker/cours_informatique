...
On a vu ce que pouvait faire une machine de Turing, voyons ce qu'elle **ne peut pas** faire.

On se place ici dans le cas où la machine de Turing a l'alphabet 01# et accepte une entrée et redonne une sortie

C'est donc une fonction de 01$\star$ dans 01$\star$

## Calculables

On a vu dans la partie qu'un algorithme ne pouvait pas tout calculer, qu'il y a avait même bien plus de choses qu'on ne pouvait pas faire avec un algorithme que de chose qu'on pouvait faire avec.
