...
On appelle cette machine **déterministe** car $\delta$ est une fonction. Pour fonctionner, elle nécessite :
...
2. on initialise si besoin le ruban avec une chaîne de caractères (finie) contenant des caractères de $\Sigma$ et on place le curseur sur la première case de la chaîne.
...
![configuration](turing-configuration.png)
...
### <span id="exemple-doublement-batons"></span>Doublement des bâtons
...
On initialise cette machine avec une chaîne de 1 : $\Sigma = \\{ 1 \\}$ (et $\Gamma = \\{ 1, \sharp \\}$).
...
![doublement de batons](turing-7.png)
...
## <span id="substantifique-moelle"></span>Substantifique moelle de la machine de Turing
...
#### <span id="plusieurs-rubans"></span>Machines à plusieurs rubans
...
### <span id="alphabet-01"></span>Simplification de l'alphabet
