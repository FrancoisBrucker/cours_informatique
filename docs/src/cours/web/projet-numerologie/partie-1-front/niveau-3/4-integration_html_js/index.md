...
title: "Projet numérologie / partie 1 : front / niveau 3 / intégration html et js"
...
eleventyNavigation:
  key: "Projet numérologie / partie 1 : front / niveau 3 / intégration html et js"
...
* [tâche 1 du niveau 1](../../niveau-1/4-integration_html_js#tache-1). Puis on commit avec le message *"action clique bouton"*
* [tâche 2 du niveau 1](../../niveau-1/4-integration_html_js#tache-2). Puis on commit avec le message *"integration numerologie.js"*
* [tâche 3 du niveau 1](../../niveau-1/4-integration_html_js#tache-2). Puis on commit avec le message *"utilisation numerologie.js"*
...
Dans le projet local, pour le même fichier `numérologie`{.fichier}, on garde les tests en fin de fonction, et on ajoute des séparateur entre chaque test :
...
![problème de rebase](./partie-1-niveau-3-projet-rebase-soucis.png)
...
Il y a 1 conflit, git n'a pas réussi à fusionner le fichier tout seul. Si vous ouvrez `numerologie.js`{.fichier} dans vscode, vous verrez le soucis :
...
![fin du problème de rebase](./partie-1-niveau-3-projet-rebase-soucis-fini.png)

On peut finir le rebase. Nous sommes maintenant uniquement en avance de 4 commits sur le serveur, dont l'état actuel est cohérent avec ce que l'on sait (auparavant il avait divergé d'un commit). On *push origin*.
...
On utilise souvent git en ligne de commande. Vous pouvez poursuivre en lisant plus avant le [cours sur git]({{"/cours/gestion-des-sources" | url}}) qui vous donnera les bases de ce merveilleux outil.
