...
> TBD exemples :
>
> - discret (admet des k-colorations pour tout k>0)
> - arbre
> - cycle pair
> - cycle impair C5
> - clique K6

Les exemples précédent le montrent, il existe une borne minimum pour tout graphe.
...
Bien sur, selon l'ordre choisi on peut trouver un bon coloriage comme un coloriage moins bon.

> TBD exemple

> Ordre décroissant Welch-Powel.
...
{% note "**Corollaire**" %}
Un graphe est 2-coloriable si et seulement si il est bi-parti.
{% endnote %}
...
Pour terminer, il nous reste à montrer que `3-colorable` est NP-complet :
...
Même si le problème général est NP-complet, il existe quelques astuces et propositions les concernant.
