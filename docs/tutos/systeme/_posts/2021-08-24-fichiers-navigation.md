...
> Le nom des dossiers sur le disque dur et celui qui apparait dans l'explorateur de fichier peuvent être différent selon la langue du système d'exploitiation. 
